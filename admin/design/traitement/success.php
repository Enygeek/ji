...
body{
    ...
    header{
			padding-top: 0.5%;
			background-color: rgba(1,15,50,0.8);
			color:white;
		}
		nav{
			clear:both;
			background-color: rgba(1,15,50,0.5);/*rgb(15, 224, 162);*/
			border-bottom-left-radius: 10px;
    		border-bottom-right-radius: 10px;
		}
...
<body>
	...
	<header>
		...
		<h1 style="text-indent: 40px; font-size: 45px; font-family:forte; margin-top:1%;">VERSCO<span style="color:aqua">SCO</span></h1>
		<nav style="margin-top:1%;"><a href="deconnexion.php"><button class="btn btn-danger" style="font-size: 13px;margin-left: 8%;" type="button"> DECONNEXION </button></a></nav>
	</header>
    ...
    <div class="page-wrapper p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
					<h2 class="title">Inscription effectué</h2>
					<a href="../index.php" class="p-t-20">
						<button class="btn btn--radius btn--green" id="btn" type="submit">Effectuer une nouvelle inscription</button>
					</a>
                </div>
            </div>
        </div>
